...
/*  Construct a C program which includes a function, calculateBMI(), that prompts the user to input a weight, in pounds, and height, in inchese, and then calculates and displays the body mass index. */
...
int calculateBMI(void){
    ...
    // Display output of user's BMI value and classification
    if(BMI >= 30.0){
